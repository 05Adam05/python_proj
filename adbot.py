...
Ночью +6°с\n\
Пасмурно")
	elif str(data) == '2017-12-21':
		bot.send_message(message.chat.id, "Днем +8°с\n\
Ночью +4°с\n\
Небольшой дождь")
	elif str(data) == '2017-12-22':
		bot.send_message(message.chat.id, "Днем +6°с\n\
Ночью +2°с\n\
Пасмурно")
	elif str(data) == "2017-12-23":
		bot.send_message(message.chat.id, "Днем +4°с\n\
Ночью +4°с\n\
Небльшой дождь")
	elif str(data) == "2017-12-24":
		bot.send_message(message.chat.id, "Днем +4°с\n\
...
@bot.message_handler(regexp="Салам Алейкум")
def answer(message):
